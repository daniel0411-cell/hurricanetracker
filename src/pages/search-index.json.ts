...
const pages: Entry[] = [
  ...
  { title: "2026 Hurricane Season", url: "/2026-hurricane-season/", description: "Track the 2026 Atlantic hurricane season with live NHC storms, the full name list, forecasts, and state impact links.", category: "Tracker", body: "2026 hurricane season live tracker storm list forecast nhc named storms state impacts" },
  ...
  { title: "Contact HurricaneHub", url: "/contact/", description: "Contact HurricaneHub about corrections, privacy, accessibility, partnerships, and general questions.", category: "About", body: "contact hurricanehub corrections privacy accessibility partnerships questions" },
  { title: "HurricaneHub Privacy Policy", url: "/privacy/", description: "Review how HurricaneHub uses analytics, cookies, local storage, subscriptions, notifications, third-party services, and advertising.", category: "About", body: "privacy policy cookies analytics local storage subscriptions notifications advertising data" },
  { title: "HurricaneHub Terms of Use", url: "/terms/", description: "Review the terms, safety limits, acceptable use, external-link, advertising, and liability information for HurricaneHub.", category: "About", body: "terms of use safety limits acceptable use external links advertising liability" },
  ...
  { title: "Hurricane Business Preparedness", url: "/tools/business-preparedness/", description: "Build a hurricane preparedness supply and continuity list for businesses, workplaces, employees, records, remote work, and recovery.", category: "Tools", body: "hurricane business supply list hurricane preparedness list for businesses workplace continuity employee communication" },
...
const localPreparednessEntries: Entry[] = localPreparednessPages.map((page) => ({
  title: page.title,
...
const entries: Entry[] = [...pages, ...stateEntries, ...topicEntries, ...cityEntries, ...stormEntries, ...localPreparednessEntries, ...stormArchiveEntries, ...blogCategoryEntries, ...blogEntries];
