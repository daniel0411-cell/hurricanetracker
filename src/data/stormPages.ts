...
export const stormTrackerPages: StormTrackerPage[] = [
  ...
  },
  {
    ...
    overview:
      "Use this Hurricane Edouard tracker page as a standing hub for NHC status checks, official advisory links, radar and satellite shortcuts, and local preparedness tools. Edouard would be the fifth named storm of the 2026 Atlantic season (after Arthur, Bertha, Cristobal, and Dolly) and would only receive the name if a system reaches tropical-storm strength. Until then, use the page for monitoring, source-checking, and review of past Edouard storms.",
    trackerFocus: [
  ...
  },
  {
    ...
    overview:
      "Use this Hurricane Fay tracker page as a standing hub for NHC status checks, official advisory links, radar and satellite shortcuts, and local decision tools. Fay would be the sixth named storm of the 2026 Atlantic season (after Arthur, Bertha, Cristobal, Dolly, and Edouard) and would only receive the name if a system reaches tropical-storm strength. Until then, use the page for preparedness context, source-checking, and review of past Fay storms, which have a notable history of U.S. landfalls.",
    trackerFocus: [
